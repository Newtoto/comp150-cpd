...
_________________________________
<h3>Week 5</h3>
<p>Since I have had experince with SQL databases in the past, I thought this would be a fairly ok session for me, however it shot past my previous knowledge and I feel it left a lot of people confused including me as to what to do especially with the server sign up requirements of Amazon's system. This is definitely something I will have to revisit to get to grips with, maybe trying to ease myself in a little slower than the session did. I ended up tagging along with someone else who was getting things to work to at least get the basics of what to do.</p>
_________________________________
<h3>Week 6</h3>
<p>I am getting pretty annoyed with the state of our SVN as it is a complete mess, quite a lot of which is down to me. I need to make sure that future projects are a lot cleaner, with a key factor being what is put on source control in the first place. The file structure of the project is also very confusing with 3 folders called character animations, and only one of which that actually has the character animations in it. This is hard to change now that the assets are so ingrained into the project. Again this needs to be something sorted at the start and stuck to for more organised future projects.</p>
_________________________________
<h3>Week 7</h3>
<p>I have deducted that the main cause of stress in this project has been the weird way in which UE4.12.5 has been put onto the machines, this is the reason that the FMOD plugin hasn't been working correctly and it's a bit of a pain since the audio is a key part of our game to create the atmosphere and sense of dread and panic.</p>
_________________________________
<h3>Week 8</h3>
<p>Show and tell week meant an intense grind to get the assets in ready for a trailer to look nice. I actually kinda wanted to present our game, but the majority of the team were for getting the less involved members to present it in order to encourage their involvement. In the end I think the presentation went quite well, but it was clear that the key aspects and usps of our game had got muddled and lost along the way.</p>
_________________________________
<h3>Week 9</h3>
<p>With the game in content lock, I have started to work almost solely on my personal projects since they have received fairly little attention relative to the group game. Work timing allocations has been poor for me this term and is definitely a point I plan to expand on for my semester reflection. Up until now my personal projects have been crammed into a couple of days of solid work, which means that I don't have time to think over what I'm doing and come up with solutions on the backburner. This fashion of working is far more stressfull than an even split since I am subconsciously thinking about how to code things when I'm away from the computer.</p>
_________________________________
<h3>Week 10</h3>
<p>This week has actually be fairly chill from what I have seen from other teams. It was agreed amongst the team that the trailer was the content lock for our game and little work has been done on it since, meaning that the build was able to be done with only a few tweaks to the project. The point still stands that the resultant game was mixed up in terms of what it was trying to deliver.</p>
_________________________________
